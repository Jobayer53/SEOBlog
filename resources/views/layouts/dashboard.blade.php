        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('home')}}" class="brand-logo">
                <img class="logo-abbr" src="{{asset('backend_asset/assets/images/logo.png')}}" alt="">
                <img class="logo-compact" src="{{asset('backend_asset/assets/images/logo-text.png')}}" alt="">
                <img class="brand-title" src="{{asset('backend_asset/assets/images/logo-text.png')}}" alt="">
            </a>
       ...
       <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{route('blog_content.index')}}" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-381-controls-3"></i>
                        <span class="nav-text">Blog Content</span>
                        </a>
                    </li>
