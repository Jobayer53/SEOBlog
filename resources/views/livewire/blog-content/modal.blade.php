    ...
    <div class="modal-dialog modal-lg" >
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="createModal">Create Blog Content</h5>
        ...
        <div class="modal-body">
            <form wire:submit.prevent="store" >
                ...
                <div class="form-group">
                    ...
                    <select name="blog_id" wire:model="blog_id" class="form-control default-select">
                        @if ($blogs->count('id') == 0)
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-default " wire:model="contentTitle">
                    @error('contentTitle')
                    <strong class="text text-danger"> {{$message}} </strong>
                    @enderror
                </div>
                ...
                <div wire:ignore class="form-group">
                    ...
                    <div name="body" id="summernote"  wire:model="content"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-default "  wire:model="video" >
                </div>
                <div class="form-group">
...
{{--
                <div wire:ignore class="form-group">
                    <label for="" class="form-label">Content</label>
                    <textarea name="body" id="editsummernote" cols="30" rows="40" placeholder="Body" wire:model="content"></textarea>
                </div>
                @error('content')
                        <strong class="text text-danger"> {{$message}} </strong>
                @enderror
