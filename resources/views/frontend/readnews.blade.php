                ...
                <div class="container mx-auto px-2 md:flex gap-x-10 text-justify">
                    <div class="md:w-[75%]">
                        <h2 class="lg:text-4xl md:text-2xl text-xl font-bold mb-16 uppercase">
                            Climate Scientist Michael Mann Awarded $1 Million in
                            Defamation Lawsuit
                        </h2>
                        <img src="./assets/About Author featured image.png" />
                        <p class="text-sm mt-5 md:w-[70%]">
                            Michael Mann discusses the famous "hockey stick”
                            graph, showing the sharp recent upward trend of
                            northern hemisphere temperatures, during his TEDx
                            presentation on climate change at Penn State
                            University on Dec. 5, 2011. TEDx Talks / YouTube
                            screenshot
                        </p>
                        <div class="my-10 flex justify-between">
                            <div class="w-[88%]">
                                <p>
                                    Climate scientist Michael Mann was awarded
                                    more than $1 million on Thursday in a
                                    defamation lawsuit against two conservative
                                    bloggers — Mark Steyn, a National Review
                                    contributor, and Rand Simberg, a former
                                    adjunct scholar — over comments about his
                                    work.
                                </p>
                                <p class="mt-5">
                                    The case goes back 12 years, during a time
                                    when global warming’s existence was hotly
                                    debated in the “blogosphere,” reported The
                                    New York Times.
                                </p>
                                <p class="mt-5">
                                    The unanimous verdict in District of
                                    Columbia Superior Court was decided by a
                                    six-member jury following a four-week trial.
                                    Steyn and Simberg were both found guilty of
                                    defamation for making false statements with
                                    “maliciousness, spite, ill will, vengeance
                        ...
                        <blockquote
                            ...
                            data-instgrm-permalink="https://www.instagram.com/p/C3GlSW9rL9s/?utm_source=ig_embed&amp;utm_campaign=loading"
                        ...
                        >
                            <div style="padding: 16px">
                                <a
                                    href="https://www.instagram.com/p/C3GlSW9rL9s/?utm_source=ig_embed&amp;utm_campaign=loading"
                                    style="
                                        background: #ffffff;
                                        line-height: 0;
                                        padding: 0 0;
                                ...
                                >
                                    <a
                                        ...
                                        "
                                        target="_blank"
                                        >A post shared by Michael E. Mann
                                        (@michaelmannscientist)</a
                                    >
                                </p>
                            </div>
                        </blockquote>
                        <p>
                            Mann’s famous “hockey stick” graph published in
                            Nature in 1998 showed the sharp upward trend of
                            northern hemisphere temperatures in the 20th
                            century, The Guardian reported.
                        </p>
                        <p class="mt-5">
                            In 2001, Mann’s illustration was included in a
                            United Nations climate panel report, as well as
                            featured in An Inconvenient Truth, Al Gore’s 2006
